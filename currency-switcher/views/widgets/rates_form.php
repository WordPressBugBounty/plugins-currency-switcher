...
<p>
    <label for="<?php echo esc_attr($widget->get_field_id('exclude')); ?>"><?php  esc_html_e('Currencies excluding from view', 'currency-switcher') ?>:</label>
    ...
    <br /><i><?php esc_html_e('Examples: EUR,GBP,UAH', 'currency-switcher') ?></i>
</p>


<p>
    <label for="<?php echo esc_attr($widget->get_field_id('precision')); ?>"><?php esc_html_e('Precision', 'currency-switcher') ?>:</label>
    ...
    <br /><i><?php esc_html_e('Count of digits after point', 'currency-switcher') ?></i>
</p>
