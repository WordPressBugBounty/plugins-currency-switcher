...
ℹ️&nbsp;**Price info icon**: show info icon near the price which while its under mouse hover shows prices in all other currencies
...
= 1.3.2 =
* security fix, thanks to hhhai from patchstack.com
