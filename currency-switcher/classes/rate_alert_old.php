                    ...
                    <table style="width: 100%; margin-bottom: 7px;">
                        <tr>
                            <td style="width: 33%; text-align: left;">
                                <a href="javascript: wpcs_manage_alert(0);void(0);" class="button button-large dashicons-before dashicons-clock">&nbsp;<?php echo esc_html__('Nope, maybe later!', 'currency-switcher') ?></a>
                            </td>

                            <td style="width: 33%; text-align: center;">
                                <a href="<?= esc_attr($link) ?>" target="_blank" class="wpcs_button dashicons-before dashicons-star-filled">&nbsp;<?php echo esc_html__('Ok, you deserve it', 'currency-switcher') ?></a>
                            </td>

                            <td style="width: 33%; text-align: right;">
                                <a href="javascript: wpcs_manage_alert(1);void(0);" class="button button-large dashicons-before dashicons-thumbs-up">&nbsp;<?php echo esc_html__('Thank you, I did it!', 'currency-switcher') ?></a>
                            </td>
                        </tr>
                    </table>
